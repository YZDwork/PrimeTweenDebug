...
namespace PrimeTween {
    internal static class Constants {
        ...
        internal const string infiniteTweenInSequenceError = "It's not allowed to have infinite tweens (cycles == -1) in a sequence. If you want the sequence to repeat forever, " + nameof(Sequence.SetCycles) + "(-1) on the parent sequence instead."; // todoo error instead of exception?
